...
public class TestClass {
	...
	public void setUp() throws Exception 
	{
		Map<String,Customer> data= new HashMap<String, Customer>();
		 Customer cust1=new Customer("Akshara", "9900112212",new Wallet(new BigDecimal(9000)));
		 Customer cust2=new Customer("Honey", "9963242422",new Wallet(new BigDecimal(6000)));
		 Customer cust3=new Customer("Sritha", "9922950519",new Wallet(new BigDecimal(7000)));
	...
	{
		service.createAccount("kavya", "999", new BigDecimal(1500));
	}
	...
	{
		service.createAccount("kavya", "", new BigDecimal(1500));
	}
	...
	{
		service.createAccount("Akshara", "9900112212", new BigDecimal(9000));
	}
	...
	{
		service.createAccount("Akshara", "9900112212", new BigDecimal(-100));
	}
	
	@Test(expected=InvalidInputException.class)
	public void testCreateAccount() 
	{
		service.createAccount("Aish", "$2#4@6!8%0", new BigDecimal(-100));
	}
	...
	{
		Customer actual=service.createAccount("Kavya", "9698495659", new BigDecimal(5000));
		Customer expected=new Customer("Kavya", "9698495659", new Wallet(new BigDecimal(5000)));
	...
	{
		Customer actual=service.createAccount("Sravya", "8754922472", new BigDecimal(0));
		Customer expected=new Customer("Sravya", "8754922472", new Wallet(new BigDecimal(0)));
	...
	{
		Customer actual=service.createAccount("Sravya", "8754922472", new BigDecimal(5000.75));
		Customer expected=new Customer("Sravya", "8754922472", new Wallet(new BigDecimal(5000.75)));
